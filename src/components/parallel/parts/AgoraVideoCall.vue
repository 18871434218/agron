...
export default {
  ...
  methods: {
    ...
    switchCamera(e) {
        ...
        if (this.camera_index != window.videoDevices.length-1){
          this.camera_index =this. camera_index+1;
          console.log(window.videoDevices[this.camera_index].deviceId);
          console.log(this.camera_index);
          this.localStream.switchDevice('video', window.videoDevices[this.camera_index].deviceId);
        }
        else {
          this.camera_index = 0;
          console.log(this.camera_index);
